  ...
  return (
    <DrawerContentScrollView {...props} contentContainerStyle={styles.container}>
      ...
      <View style={styles.bottomLinks}>
        ...
        <TouchableOpacity style={styles.bottomLink}><Text style={styles.bottomLinkText}>Help</Text></TouchableOpacity>
        <TouchableOpacity style={styles.bottomLink}><Text style={styles.bottomLinkText}>Learning Center</Text></TouchableOpacity>
...
const styles = StyleSheet.create({
  ...
  menuLabel: { fontSize: 22, fontWeight: '700', color: Colors.black, flex: 1 },
  ...
  bottomLinkText: { fontSize: 14, color: Colors.textSecondary, fontWeight: '500' },
});
